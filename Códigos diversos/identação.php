...
{
    $estoque[] = ['codigo' => $codigo, 'nome' => $nome, 'tamanho' => $tamanho, 'cor' => $cor, 'quantidade' => $quantidade];
}
...
$estoque[] = ['codigo' => 1, 'nome' => 'Camisa Polo', 'tamanho' => 'P', 'cor' => 'Branca', 'quantidade' => 5];
while (true) {
    $opcao = exibirMenu();
    switch ($opcao) {
        case 1:
